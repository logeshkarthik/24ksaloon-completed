...
<html>
<head>
<title>View Users|24K Saloon</title>
...
.flex-container>div {
	...
	<div style="position: relative;">
		...
		<div id="myNav" class="overlay">
			...
			<div class="overlay-content">
				<a href="index.jsp" onclick="closeNav()">Home</a> <a
					href="admin.jsp" onclick="closeNav()">Admin Dashboard</a> <a
					href="myaccount.jsp" onclick="closeNav()">Switch Account</a> <a
					href="book appoinment.jsp" onclick="closeNav()">Book
					Appointment</a> <a href="addmember.jsp" onclick="closeNav()">Add
					Member</a> <a href="viewusers.jsp" onclick="closeNav()">view users</a>
			</div>
		</div>
		<%
		...
		<table>
			...
			<tbody>
				<tr>
					<td data-label="S.No"><%=resultSet.getString("s.no")%></td>

					<td data-label="User Name"><%=resultSet.getString("username")%></td>
					<td data-label="Phone Number"><a
						href="tel:<%=resultSet.getString("phonenumber")%>"><%=resultSet.getString("phonenumber")%></a></td>
					<td data-label="Email"><%=resultSet.getString("email")%></td>
					<td data-label="Role"><%=resultSet.getString("role")%></td>

...
<html>
<head>
<title>My Account|24K Saloon</title>
	...
	<div style="position: relative;">
		...
		<div style="text-align: center;">
			...
			<form action="myaccount" method="post">
				<label style="color: #CCA826; text-align: center;">Mobile
					Number</label><input class="login" type="tel" name="phonenumber"
					placeholder="   enter mobile number"><br> <br> <input
					class="loginbutton" type="submit" value="submit">
			</form>
